...
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
	...
	<table class="data-table" style="width: 90%">
				...
				<tr>
						...
						switch ($INPUT_TYPE):
							...
							case "T":
								...
								?>
						<textarea placeholder="<?=$title?>" cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" rows="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["ROW_COUNT"]?>" name="PROPERTY[<?=$propertyID?>][<?=$i?>]"><?=$value?></textarea>
								<?
								}
							break;
							...
							case "N":
								...
								?>
								<input placeholder="<?=$title?>" type="text" name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]; ?>" value="<?=$value?>" /><br />
								<?
		...
		<tfoot>
			<tr>
				<td colspan="2">
				<div class="small__button"><button aria-label="send message" name="iblock_submit" value="<?=GetMessage("IBLOCK_FORM_SUBMIT")?>" type="submit"
